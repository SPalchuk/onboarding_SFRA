        ...
        rules: [{
            ...
            use: ExtractTextPlugin.extract({
                use: [{
                    ...
                    options: {
                        includePaths: [
                            path.resolve(process.cwd(), '../storefront-reference-architecture-master/node_modules/'),
                            path.resolve(process.cwd(), '../storefront-reference-architecture-master/node_modules/flag-icon-css/sass')
                        ]
                    }
                }]
            })
